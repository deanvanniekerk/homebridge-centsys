...
**Status: cloud route selected; implementation pending.** The owner reports successful remote open/close through MyCentsys Remote outside nearby Bluetooth range, with displayed Closed, Opening, Open and Closing states during the test. No installable plugin or third-party connection has been implemented or tested.
